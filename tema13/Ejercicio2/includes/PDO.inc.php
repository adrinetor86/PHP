    ...
    try {
        ...
        if ($PDOConexion) {
            ...
            if ($intCantRegistros > 0) {
                ...
                echo'&nbsp &nbsp <button type="submit" formaction="../paginas/editar.php">Volver Al Registro Antiguo</button><br/></br>';
        ...
        if ($PDOConexion) {
           ...
           // $sentenciaSQL -> bindParam(':id', $id);
            ...
            while ($heroe = $sentenciaSQL->fetch()) {
                ...
                echo "<button type='submit' formaction='../paginas/editar.php' value='Confirmar'>Volver</button>";
